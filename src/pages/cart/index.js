...
const RadioItem = Checkbox.AgreeItem;
      ...
      {this.state.ids ? 
        <React.Fragment>
          <div className="car-list">
            ...
            <ul>
              {this.state.hot.slice(0, this.state.ids.length).map((item,index)=>(
                <li key={index}>
                  <div className="chebox"><CheckboxItem onChange={() => this.onChangeBox(item.productId)} key={item.productId} value={item.productId}></CheckboxItem></div>
                  <div className="imgbox"><img src={item.products.coverUrl} /></div>
                  <div className="cnt">
                    <div className="name"><span className="t">{item.products.name}</span><span className="cprice">￥11</span></div>
                    <div className="sku">
          ...
          <div className="cart-bar">
            {/* <div className="chebox"><CheckboxItem readOnly value="1">全选</CheckboxItem></div> */}
            <div className="inner">
              <div className="cprice">合计：<span className="red">￥<em className="val">199</em></span></div>
